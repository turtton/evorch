...
- [0001](../decisions/0001-no-fixed-workflow.md) 固定 workflow 不採用 / [0002](../decisions/0002-role-capability-boundaries.md) Role capability boundary / [0003](../decisions/0003-cache-first-context-engine.md) cache-first context engine / [0004](../decisions/0004-provider-routing-separation.md) provider routing 分離 / [0005](../decisions/0005-headless-kernel-and-gui-separation.md) headless kernel と GUI 分離 / [0006](../decisions/0006-self-improvement-and-diagnostics.md) 診断と自己改善 / [0007](../decisions/0007-gui-framework-egui-first.md) GUI 第一候補 egui+egui_dock / [0008](../decisions/0008-threat-model-phased-adoption.md) 脅威モデル段階導入 / [0009](../decisions/0009-platform-linux-first-gui-only.md) Linux 先行・GUI のみ / [0010](../decisions/0010-extension-architecture-v2-style.md) 拡張アーキテクチャ V2 型 / [0011](../decisions/0011-release-and-diagnostics-ops.md) リリース形態・Diagnostics 運用 / [0012](../decisions/0012-metrics-architecture.md) 計測アーキテクチャ / [0013](../decisions/0013-model-catalog.md) モデルカタログ / [0014](../decisions/0014-config-architecture.md) 設定アーキテクチャ / [0015](../decisions/0015-verification-two-layer.md) 検証2層運用 / [0016](../decisions/0016-crate-granularity.md) v0.1 crate 粒度 / [0017](../decisions/0017-event-bus-transport.md) Event Bus transport / [0018](../decisions/0018-sqlite-storage-schema.md) SQLite storage schema / [0019](../decisions/0019-runtime-reload-semantics.md) runtime reload セマンティクス / [0020](../decisions/0020-canonical-message-normalization.md) canonical message 正規化 / [0021](../decisions/0021-bwrap-linux-sandbox.md) Linux sandbox 第一実装（bwrap） / [0022](../decisions/0022-parent-child-tree-addressing-and-nested-delegation.md) 親子限定ツリー addressing と can_delegate 開放 / [0024](../decisions/0024-process-owner-claim.md) thread process owner / claim モデル

## operations/

- [config-reference.md](../operations/config-reference.md) — 設定リファレンス（host metadata・binding 運用の記録）
- clarifications/ — [open.md](../clarifications/open.md) 未解決 clarification backlog（現在 none）
- interviews/ — [drift-adjustments.json](../interviews/drift-adjustments.json) grill セッションの意思決定記録
- automation/ — [bindings.md](../automation/bindings.md) workflow label の automation binding
- packets/ — execution unit packet の配置場（seed 済み packet の queue 状態は `.intent-cli/` 管理。現状プレースホルダー）
- links/ — 外部リンク（現状プレースホルダー）
